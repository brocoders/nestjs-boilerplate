...
This project uses PostgreSQL with TypeORM for persistence. The architecture follows [Hexagonal Architecture](architecture.md#hexagonal-architecture) so the persistence layer is isolated behind repository ports.
