...
import { memoryStorage } from 'multer'; // <-- changed

import { FilesS3PresignedService } from './files.service';
import { FileScanService } from '../scan/file-scan.service'; // <-- new
    ...
    MulterModule.registerAsync({
      ...
      useFactory: (configService: ConfigService<AllConfigType>) => {
        return {
          ...
          storage: memoryStorage(), // <-- removed multerS3, presigned uploads bypass server anyway
          limits: {
