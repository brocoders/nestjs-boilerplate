...
const CriticalDateSchema = z.object({
    date: z
        .string()
        .describe('dd MMM yyyy format (e.g., "05 Feb 2025")'),
...
export const ContractSummarySchema = z.object({
    snapshot: z.object({
        ...
        parties: z.array(PartySchema).min(2).describe('Principal contracting entities'),
        effectiveDate: z
            .string()
    ...
    abstract: z
        .string()
        .max(300)
        .describe('≤ 42-word plain-English one-liner'),
