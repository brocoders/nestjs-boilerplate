...
export class SubscriptionSeedService {
  ...
  async run() {
    ...
    for (const tenant of tenants) {
      await this.seedSubscriptionsForTenant(tenant);
    }
  }

  private async seedSubscriptionsForTenant(tenant: TenantEntity) {
    ...
    const customerPlans = this.getSubscriptionConfigurations(
      tenant,
      customers,
      paymentPlans,
      adminUsers,
  ...
  private getSubscriptionConfigurations(
    tenant: TenantEntity,
