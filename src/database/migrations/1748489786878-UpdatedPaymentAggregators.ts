...
export class UpdatedPaymentAggregators1748489786878
  implements MigrationInterface
{
  name = 'UpdatedPaymentAggregators1748489786878';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "payment_aggregator" ("isActive" boolean NOT NULL, "config" jsonb, "name" character varying, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "tenantId" uuid NOT NULL, CONSTRAINT "PK_2d65d5adbb8e4fad86d4eb41f2e" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
